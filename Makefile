...
info:
	...
	$(Q)$(ECHO) "KERNEL_CONFIG:     $(KERNEL_CONFIG)"
...
stop_share:
	$(Q)$(DOCKER) kill $(BUILDER_SHARE_NAME) || $(DOCKER) rm $(BUILDER_SHARE_NAME)

clean:
	$(RM) -rf $(BUILDER_LINUX_GENCONFIG_FILE) $(BUILDER_LATEST_CONFIG_FILE) $(BUILD_DIR)

distclean:
	$(RM) -rf $(KERNEL_SRC_PATH) $(KERNEL_DIST) $(BUILDER_CCACHE_DIR)
