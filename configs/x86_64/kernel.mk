...
BUILDER_BIN_SRC_PATH_IN_LINUX=/src/binaries
...
BUILDER_ENV=	-e ARCH=$(KERNEL_ARCH) 									\
				...
				-e BIN_SRC_DIR=$(BUILDER_BIN_SRC_PATH_IN_LINUX) 		\
...
BUILDER_VOLUMES= -v $(PWD)/builder.mk:$(BUILDER_SRC_PATH_IN_LINUX)/builder.mk:ro 		\
				 ...
				 -v $(BIN_SRC_PATH):$(BUILDER_BIN_SRC_PATH_IN_LINUX)
